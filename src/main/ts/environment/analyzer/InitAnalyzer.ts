...
export class InitAnalyzer
{
    ...
    public static readonly RESOURCES: ReadOnlyDict<ReadOnlyDict<ReadonlyMap<string, boolean>>> =
    ...
    public static readonly ROOT: ReadOnlyDict<ReadOnlyDict<ReadonlyMap<string, boolean>>> =
